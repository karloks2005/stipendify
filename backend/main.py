...
app.add_middleware(CORSMiddleware, allow_origins=[FRONTEND_URL], allow_methods=["GET", "POST", "DELETE", "PUT", "PATCH"], allow_headers=["authorization"], allow_credentials=True)
